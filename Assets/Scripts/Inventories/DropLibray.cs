...
namespace RPG.Inventories
{
    ...
    [CreateAssetMenu(menuName = ("RPG/Inventory/Drop Libray"))]
    public class DropLibrary : ScriptableObject
    {
        ...
        DropConfig SelectRandomItem(int level)
        {
            ...
            float chanceTotal = 0;                                              //Counts and keeps track of relative chacne
        ...
        {
            //Gets total relative chance from all drops in our drop Catalog
            float total = 0;
